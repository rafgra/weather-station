...
class CI_DB_active_record extends CI_DB_driver {
	...
	public function select_date($select = '', $sql_date_format = '%Y-%m-%dT%H:%i:%s+01:00', $alias = '')
	{
		...
		$sql = 'DATE_FORMAT('.$this->_protect_identifiers(trim($select)).', \''.$sql_date_format.'\') AS '.$alias;
